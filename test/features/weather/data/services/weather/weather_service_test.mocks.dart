...
// in weather_app/test/features/weather/data/services/weather/weather_service_test.dart.
...
import 'package:weather_app/app/environment/environment.dart' as _i10;
...
///
/// See the documentation for Mockito's code generation for more information.
class MockEnvironment extends _i1.Mock implements _i10.Environment {
  MockEnvironment() {
    _i1.throwOnMissingStub(this);
  }
  ...
  set apiKey(String? value) => super.noSuchMethod(
    Invocation.setter(#apiKey, value),
    returnValueForMissingStub: null,
  );
}
